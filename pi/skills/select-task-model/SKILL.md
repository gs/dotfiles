...
5. If evidence is missing, propose an explicitly **UNQUALIFIED supervised trial**, with exact routes, a bounded low-risk task, provider consent, checks and independent review. User approval permits that trial without prior qualification. Record its results before expanding use. Unapproved routes and unqualified security-sensitive production work remain **BLOCKED**.
...
Record briefly in the plan: role → exact model, evidence or UNQUALIFIED trial, data boundary, approval, limits and escalation condition. Report actual checks and costs/latency when available. No claim of “best,” “cheapest,” or “qualified” without supporting evidence.
